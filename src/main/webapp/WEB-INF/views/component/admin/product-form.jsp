...
<div class="site-product">
	<form:form csscssClass="row g-3 needs-validation"
		action="/admin/product/create" modelAttribute="pd" method="POST" id="formProduct">
		<div class="row">
			<div class="col-xs-12 col-md-7">
				<div class="row">
					...
					<div class="col-md-6 mb-3">
						...
						<form:input type="number" cssClass="form-control" path="price"></form:input>
					</div>
					<div class="col-md-6 mb-3">
						...
						<form:input type="number" cssClass="form-control"
							path="quantityInStock"></form:input>
					</div>
					<div class="col-12 mb-3">
				...
				<div class="col-12">
					<form:button class="btn btn-primary" type="submit" id="btnAddProduct">${typeButton }</form:button>
				</div>
