	...
	<form:form cssClass="row g-3 needs-validation"
		...
		<div class="row">
			<div class="col-xs-12 col-md-7">
				<div class="row">
					...
					<div class="col-12 mb-3">
						...
						<form:radiobutton path="del" value="false" label="Đang hoạt động" style="margin-left:10px"/>
						<form:radiobutton path="del" value="true" label="Đã bị khóa" style="margin-left:10px"/>
			...
			<div class="col-xs-12 col-md-5">
				<div class="mb-3">
					<form:label path="image" cssClass="form-label">Hình ảnh</form:label>
					<br> <img alt=""
						src="../../../images/avatar/${userCustom.image }" id="image"
						width="300" height="300" style="margin: 10px"> <input
						name="avatar" type="file" id="imageFile"
