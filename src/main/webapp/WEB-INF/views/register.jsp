...
<body class="js">
	...
	<div
		...
		<form:form action="/account/register" method="post" cssClass="w-100"
			modelAttribute="us" id="formRegister">
			<div class="card-login p-5">
				<a class="login">TẠO TÀI KHOẢN</a> <span class="">Nếu bạn đã
					có tài khoản, đăng nhập tại đây.</span>
				...
				<button class="enter btnRegister">ĐĂNG KÝ</button>
