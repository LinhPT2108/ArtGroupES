			...
			<div class="row">
				<div class="col-lg-5 col-md-5 col-12"
					...
					<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							...
							<img class="d-block w-100" src="https://down-vn.img.susercontent.com/file/vn-11134201-7r98o-ll1wvj78hn7v6d" alt="First slide">
							</div>
							<div class="carousel-item">
							<img class="d-block w-100" src="https://down-vn.img.susercontent.com/file/vn-11134201-7r98o-ll1wvj78hn7v6d" alt="Second slide">
							</div>
							<div class="carousel-item">
							<img class="d-block w-100" src="https://down-vn.img.susercontent.com/file/vn-11134201-7r98o-ll1wvj78hn7v6d" alt="Third slide">
							</div>
						</div>
				...
				<div class="col-lg-7 col-md-7 col-12">
					<div class="thongtintensanpham">
						<div class="tensanpham">
							<span>Sữa Chống Nắng Dưỡng Da Anessa Perfect UV SPF50+/PA++++ 60ml</span>
						</div>
					</div>
					<!--số lượng bán, sao-->
					<div class="thongtinchitietsanpham d-flex flex-row">
						<button class="thongtindau d-flex flex-row">
							...
							<div class="5sao">
								<i class="bi bi-star-fill mausao">
								</i>
								<i class="bi bi-star-fill mausao">
								</i>
								<i class="bi bi-star-fill mausao">
						...
						<div class="flashsale">
							...
							<div class="dinhdangkhungdem">
								<div class="giaodiendem">
									<div style="color: white;">00</div></div>
						...
						<div style="flex-direction: column;">
							...
							<section class="d-flex flex-row" style="color:#757575;">
								<h3 style="
                					...
                					font-size: inherit;
                					font-weight: 400;
                					margin: 0;">Số lượng</h3>
								<div
									style="flex-basis: 32.1875rem; max-width:32.1875rem; flex-wrap:wrap;">
									<div style="margin-right: 15px;">
										<div class="dinhdangnutsoluong">
											<button class="nut"><i class="bi bi-dash-lg nutgiam"></i></button>
											<input class="nut soluong" aria-live="assertive" aria-valuenow="1"
												value="1" type="text" role="spinbutton" name id>
											<button class="nut"><i class="bi bi-plus-lg nuttang"></i></button>
										</div>
									</div>
					...
					<div style="margin-top: 15px;">
						<div style="padding-left: 1.25rem;">
							...
							<button type="button" class="nutgiohang maunutmua">
								Thêm vào giỏ hàng
							</button>
							<button type="button" class="nutgiohang maunutmua">Mua ngay</button>
							<a href class="nutgiohang maunutthich">
								<span style="color: red;"><i class="bi bi-heart"></i></span>
							</a>
							</div>
						</div>
					</div>
				...
				<div class="bocucchitietsanpham">
					...
					<section class="motasanpham">
						...
						<div style="margin: 1.875rem .9375rem .9375rem;">
							<p>Thành phần và công dụng:

								- Sữa Chống Nắng Dưỡng Da Anessa Perfect UV SPF50+/PA++++ sữa chống nắng
								dưỡng da và bảo vệ da tối đa với kết cấu mỏng nhẹ, khô ráo.

								- Hiệu quả chống trôi trong nước rất cao với công nghệ Aqua Booster EX.

								- Dưỡng da ẩm mượt, gia tăng độ đàn hồi, chống oxi hoá, và kiểm soát
								bóng dầu.

								- Có thể dùng làm lớp lót trang điểm, dễ dàng làm sạch với sữa rửa mặt.

								- Dùng cho mặt và toàn thân.

								- Thích hợp sử dụng hàng ngày và các hoạt động ngoài trời.

								- Công thức được kiểm nghiệm bởi chuyên gia da liễu, an toàn cho sức
								khỏe người tiêu dùng.</p>
						</div>
					</section>
				</div>
			</div>
						...
						<div class="comment-rating">
							...
							<div class="main-rating" style="flex: 1;">
								...
								<div style="margin: 0.5rem 0 0.5rem 0;">
									Kem chống nắng của anessa thì khỏi chê rồi. Mk mua sales xong lại đc
									tặng sample nhỏ nhỏ xinh tật sự.
								</div>
		...
		<div>
			<div class="dinhdangkhungcacspkhac">
				...
				<div
					...
					<div style="height: 100%; overflow: hidden; touch-action: pan-y;">
						<ul
							...
							<div id="carouselExampleControls" class="carousel slide"
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<li style="padding: 0px; width: 100%; overflow-x: hidden; 
											list-style: none; float: left; touch-action: pan-y; margin: 10px;"
													...
													<div class="dinhdangkhungtitlespkhac">
														<div
															...
															<div class="phan-title-sanphamkhac">
																<div class="dinh-dang-title-sanpham">
																	Sữa chống nắng bảo vệ hoàn hảo Anessa Perfect UV Sunscreen
																	Skincare Milk 60ml
																</div>
															</div>
															<div class="phan-gia-sanphamkhac">
																<div class="khung-gia-sanphamkhac">
																	<span style="color: rgb(238, 77, 45);">₫</span>
																	<span class="dinh-dang-gia-sanphamkhac">469.000</span>
																</div>
															</div>
														</div>
													</div>
					...
					list-style: none;
					float: left;
					touch-action: pan-y; margin: 10px;" class="d-flex flex-row">
											<!-- 1 sp  -->
											<div class="dinhdangkhung1product">
												<div class="dinhdangvien1product">
													<!-- định dạng hình ảnh sản phẩm -->
