			...
			<div class="card-login p-5">
				...
				<div class="inputBox">
					<input type="text" required="required" autocomplete="none"
						name="LGemail" value="${LGemail }"> <span class="user">Email</span>
				...
				<div class="form-check m-0">
					<input type="checkbox" class="form-check-input" name="chkRemember" id="chkRemember" value="true">
					<label class="form-check-label" for="chkRemember">Ghi nhớ tài khoản</label>
				</div>
				<div class="error">
